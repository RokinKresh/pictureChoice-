...
//    _imageContent.contentSize = CGSizeMake(self.bounds.size.width, 320);
    ...
    imageItem.center = CGPointMake(16 + _itemWidth / 2.0 + (_itemWidth + 10 ) * Yrow, _itemWidth / 2.0 +  (_itemWidth + 10 ) * Xrow);
    ...
    [_imageContent addSubview:imageItem];
...
//    NSInteger hItemCont = _subviewArray.count / 3;
    for (int i = 0; i < _subviewArray.count; i++) {
        ...
        NSInteger Xrow = i / 3;
        NSInteger Yrow = i % 3;
        changeSub.center = CGPointMake(16 + _itemWidth / 2.0 + (_itemWidth + 10 ) * Yrow, _itemWidth / 2.0 +  (_itemWidth + 10 ) * Xrow);
    }
